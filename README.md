...
- **Sample 01** (You will see below first the recipe and its image output)
...
- **Sample 02** (You will see below first the recipe and its image output)
...
- **Sample 03** (You will see below first the recipe and its image output)
...
- **Sample 04** (You will see below first the recipe and its image output) (100 Epoch; however, there was no significant difference this time)
...
- **Sample 05** (You will see below first the recipe and its image output)
